...
function [low,up,dims] = GetBounds(funcName,dims)
    ...
    switch(funcName)
        ...
        case 'Rodamientos' %   Rolling Element Bearing Design problem:
            [low,up,dims]=Rodamientos.Bounds(dims);
        ...
        %% TemplateMatching N=2
        case 'TMBoard1'
            [low,up,dims]=TMBoard1.Bounds(dims);
        case 'TMBoard2'
            [low,up,dims]=TMBoard2.Bounds(dims);        
        case 'TMBoard3'
            [low,up,dims]=TMBoard3.Bounds(dims); 
        case 'TMBrachio'
            [low,up,dims]=TMBrachio.Bounds(dims);
        case 'TMHeadRaptor'
            [low,up,dims]=TMHeadRaptor.Bounds(dims);
        case 'TMMap'
            [low,up,dims]=TMMap.Bounds(dims);
        case 'TMRaptor'
            [low,up,dims]=TMRaptor.Bounds(dims);
        case 'TMWallE'
            [low,up,dims]=TMWallE.Bounds(dims);
        case 'TMWally'
            [low,up,dims]=TMWally.Bounds(dims);
